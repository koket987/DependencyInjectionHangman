...
public class CreditsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        creditsLabel.setFont(new Font("Arial Black", 0, 36));
        creditsLabel.setForeground(new Color(255, 255, 255));
        creditsLabel.setHorizontalAlignment(SwingConstants.CENTER);
        creditsLabel.setVerticalAlignment(SwingConstants.CENTER);
        creditsLabel.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
