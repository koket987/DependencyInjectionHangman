...
public class SplashPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new Font("Georgia", 0, 42));
        titleLabel.setForeground(new Color(255, 255, 255));
        titleLabel.setHorizontalAlignment(SwingConstants.CENTER);
        titleLabel.setBorder(BorderFactory.createEmptyBorder(25, 0, 0, 0));
        this.add(titleLabel, BorderLayout.PAGE_START);

        teamLabel = new JLabel("Placeholder");
        teamLabel.setFont(new Font("Georgia", 0, 36));
        teamLabel.setForeground(new Color(255, 255, 255));
        teamLabel.setHorizontalAlignment(SwingConstants.CENTER);
        teamLabel.setBorder(BorderFactory.createEmptyBorder(0, 0, 25, 0));
